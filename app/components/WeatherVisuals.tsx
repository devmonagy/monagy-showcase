...
// Shared weather visuals for the Off The Clock telemetry board — icon,
// orb gradient, and label map, split out from the old card widget so the
// Bento tile can compose them freely. Naturalistic per-condition colors on
// purpose (sun = warm amber, rain = blue, etc.): a weather readout looks
// more alive resembling the actual sky than tinted in the brand accent.
